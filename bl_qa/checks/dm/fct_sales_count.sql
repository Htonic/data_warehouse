CREATE OR ALTER  PROCEDURE bl_qa.fct_sales_count
AS
...
BEGIN
    ...
    WITH nf as (SELECT COUNT(*) as cnt_nf FROM bl_3nf.dbo.ce_sales),
	dm as (SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.fct_sales)
	...
	SELECT 'Check counts between bl_3nd and bl_dm for sales' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check counts between bl_3nd and bl_dm for sales finished with status_id: ', @status_id);
