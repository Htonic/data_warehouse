CREATE OR ALTER  PROCEDURE bl_qa.dim_payment_types_duplicates
AS
...
BEGIN
	...
	WITH duplicated_records as (
		SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.dim_payment_types group by payment_type_natural_id having count(*) > 1)
	...
	SELECT 'Check duplicates for dim_payment_types' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check duplicates for dim_payment_types finished with status_id: ', @status_id);
