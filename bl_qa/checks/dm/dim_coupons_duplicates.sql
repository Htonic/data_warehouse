CREATE OR ALTER  PROCEDURE bl_qa.dim_coupons_duplicates
AS
...
BEGIN
	...
	WITH duplicated_records as (
		SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.dim_coupons group by coupon_natural_id having count(*) > 1)
	...
	SELECT 'Check duplicates for dim_coupons' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check duplicates for dim_coupons finished with status_id: ', @status_id);
