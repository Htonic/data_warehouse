CREATE OR ALTER  PROCEDURE bl_qa.dim_products_types_check
AS
DECLARE @failed_count INT;
DECLARE @failed_perc DECIMAL(18, 2);
DECLARE @status_id  INT;
DECLARE @table_name NVARCHAR(20) = 'dim_products';
...
BEGIN
	...
	('brand_type NOT NULL nvarchar(20)'),
	('product_category_desc NOT NULL nvarchar(40)'),
	('is_active NOT NULL nvarchar(1)'),
	('product_surrogate_id NOT NULL int'),
	('product_id NOT NULL int'),
	('product_natural_id NOT NULL int'),
	('brand NOT NULL int'),
	('brand_id NOT NULL int'),
	('brand_type_id NOT NULL int'),
	('update_dt NOT NULL date'),
	('product_category_id NOT NULL int'),
	...
	SELECT 'Data types check for dim_products' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check data types for dim_products finished with status_id: ', @status_id);
