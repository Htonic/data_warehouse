CREATE OR ALTER  PROCEDURE bl_qa.dim_dates_types_check
AS
DECLARE @failed_count INT;
DECLARE @failed_perc DECIMAL(18, 2);
DECLARE @status_id  INT;
DECLARE @table_name NVARCHAR(20) = 'dim_dates';
...
BEGIN
	...
	('fulldate_desc NOT NULL nvarchar(40)'),
	('day_of_week_desc NOT NULL nvarchar(25)'),
	('calendar_month_desc NOT NULL nvarchar(25)'),
	('sale_date NOT NULL date'),
	('day_number_in_week NOT NULL int'),
	('day_number_in_calendar_month NOT NULL int'),
	('day_number_in_calendar_year NOT NULL int'),
	('calendar_week_number_in_year NOT NULL int'),
	('calendar_month NOT NULL int'),
	('calendar_quarter NOT NULL int'),
	('calendar_year NOT NULL int'),
	('day_number_in_fiscal_month NOT NULL int'),
	('day_number_in_fiscal_year NOT NULL int'),
	...
	SELECT 'Data types check for dim_dates' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check data types for dim_dates finished with status_id: ', @status_id);
