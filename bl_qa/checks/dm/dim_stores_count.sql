CREATE OR ALTER  PROCEDURE bl_qa.dim_stores_count
AS
...
BEGIN
    ...
    WITH nf as (SELECT COUNT(*) as cnt_nf FROM bl_3nf.dbo.ce_stores),
	dm as (SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.dim_stores)
	...
	SELECT 'Check counts between bl_3nd and bl_dm for stores' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check counts between bl_3nd and bl_dm for stores finished with status_id: ', @status_id);
