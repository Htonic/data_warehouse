CREATE OR ALTER  PROCEDURE bl_qa.dim_employees_types_check
AS
DECLARE @failed_count INT;
DECLARE @failed_perc DECIMAL(18, 2);
DECLARE @status_id  INT;
DECLARE @table_name NVARCHAR(20) = 'dim_employees';
...
BEGIN
	...
	('employee_name NOT NULL nvarchar(80)'),
	('employee_surname NOT NULL nvarchar(80)'),
	('email NOT NULL nvarchar(80)'),
	('phone NOT NULL nvarchar(80)'),
	('employee_surrogate_id NOT NULL int'),
	('employee_id NOT NULL int'),
	('employee_natural_id NOT NULL int'),
	('age NOT NULL int'),
	...
	SELECT 'Data types check for dim_employees' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check data types for dim_employees finished with status_id: ', @status_id);
