CREATE OR ALTER  PROCEDURE bl_qa.dim_payment_types_count
AS
...
BEGIN
    ...
    WITH nf as (SELECT COUNT(*) as cnt_nf FROM bl_3nf.dbo.ce_payment_types),
	dm as (SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.dim_payment_types)
	...
	SELECT 'Check counts between bl_3nd and bl_dm for payment types' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check counts between bl_3nd and bl_dm for payment types finished with status_id: ', @status_id);
