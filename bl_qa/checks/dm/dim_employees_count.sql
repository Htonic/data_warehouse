CREATE OR ALTER  PROCEDURE bl_qa.dim_employees_count
AS
...
BEGIN
    ...
    WITH nf as (SELECT COUNT(*) as cnt_nf FROM bl_3nf.dbo.ce_employees),
	dm as (SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.dim_employees)
	...
	SELECT 'Check counts between bl_3nd and bl_dm for employees' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check counts between bl_3nd and bl_dm for employees finished with status_id: ', @status_id);
