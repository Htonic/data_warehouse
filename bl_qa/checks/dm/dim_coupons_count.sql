CREATE OR ALTER  PROCEDURE bl_qa.dim_coupons_count
AS
...
BEGIN
    ...
    WITH nf as (SELECT COUNT(*) as cnt_nf FROM bl_3nf.dbo.ce_coupons),
	dm as (SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.dim_coupons)
	...
	SELECT 'Check counts between bl_3nd and bl_dm for coupons' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check counts between bl_3nd and bl_dm for coupons finished with status_id: ', @status_id);
