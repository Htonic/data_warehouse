CREATE OR ALTER  PROCEDURE bl_qa.fct_sales_duplicates
AS
...
BEGIN
	...
	WITH duplicated_records as (
		SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.fct_sales group by sale_id having count(*) > 1)
	...
	SELECT 'Check duplicates for fct_sales' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check duplicates for fct_sales finished with status_id: ', @status_id);
