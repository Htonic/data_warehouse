CREATE OR ALTER  PROCEDURE bl_qa.dim_customers_duplicates
AS
...
BEGIN
	...
	WITH duplicated_records as (
		SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.dim_customers group by customer_natural_id having count(*) > 1)
	...
	SELECT 'Check duplicates for dim_customers' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check duplicates for dim_customers finished with status_id: ', @status_id);
