CREATE OR ALTER  PROCEDURE bl_qa.dim_stores_duplicates
AS
...
BEGIN
	...
	WITH duplicated_records as (
		SELECT COUNT(*) as cnt_dm FROM bl_dm.dbo.dim_stores group by store_id having count(*) > 1)
	...
	SELECT 'Check duplicates for dim_stores' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check duplicates for dim_stores finished with status_id: ', @status_id);
