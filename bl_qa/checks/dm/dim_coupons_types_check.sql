CREATE OR ALTER  PROCEDURE bl_qa.dim_coupons_types_check
AS
DECLARE @failed_count INT;
DECLARE @failed_perc DECIMAL(18, 2);
DECLARE @status_id  INT;
DECLARE @table_name NVARCHAR(20) = 'dim_coupons';
...
BEGIN
	...
	SELECT 'Data types check for dim_coupons' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check data types for dim_coupons finished with status_id: ', @status_id);
