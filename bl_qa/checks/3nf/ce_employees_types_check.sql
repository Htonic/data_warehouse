CREATE OR ALTER  PROCEDURE bl_qa.ce_employees_types_check
AS
DECLARE @failed_count INT;
DECLARE @failed_perc DECIMAL(18, 2);
DECLARE @status_id  INT;
DECLARE @table_name NVARCHAR(20) = 'ce_employees';
...
BEGIN
	...
	SELECT 'Data types check for ce_employees' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check data types for ce_employees finished with status_id: ', @status_id);
