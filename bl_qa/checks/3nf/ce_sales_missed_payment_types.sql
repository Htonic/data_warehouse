CREATE OR ALTER  PROCEDURE bl_qa.ce_sales_missed_payment_types
AS
...
BEGIN
    SELECT @failed_count = COUNT(*)  
		...
		WHERE payment_type_id = -1 OR payment_type_id IS NULL;
	...
	SELECT 'Check payment types mapping for ce_sales' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check number of sales with undefined payment type: ', @status_id);
