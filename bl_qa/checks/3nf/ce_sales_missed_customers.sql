CREATE OR ALTER  PROCEDURE bl_qa.ce_sales_missed_customers
AS
...
BEGIN
	...
	SELECT 'Check customers mapping for ce_sales' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check number of sales with undefined customer: ', @status_id);
