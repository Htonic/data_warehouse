CREATE OR ALTER  PROCEDURE bl_qa.ce_sales_missed_coupons
AS
...
BEGIN
    SELECT @failed_count = COUNT(*)  
		...
		WHERE coupon_id = -1 OR coupon_id IS NULL;
	...
	SELECT 'Check employees mapping for ce_sales' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check number of sales with undefined employee: ', @status_id);
