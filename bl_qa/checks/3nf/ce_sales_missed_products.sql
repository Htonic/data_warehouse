CREATE OR ALTER  PROCEDURE bl_qa.ce_sales_missed_products
AS
...
BEGIN
	...
	SELECT 'Check products mapping for ce_sales' as check_name,
	@failed_perc,
	...
	SET @event_message = CONCAT('Check number of sales with undefined product: ', @status_id);
